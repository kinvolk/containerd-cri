...
type PluginConfig struct {
	...
	// NodeWideUIDMapping is the UID mapping to use when NamespaceOption.User = NODE_WIDE_REMAPPED
	NodeWideUIDMapping LinuxIDMapping `toml:"node_wide_uid_mapping" json:"nodeWideUIDMapping"`
	// NodeWideGIDMapping is the GID mapping to use when NamespaceOption.User = NODE_WIDE_REMAPPED
...
func DefaultConfig() PluginConfig {
	return PluginConfig{
		...
		NodeWideGIDMapping: LinuxIDMapping{0, 100000, 65536},
	}
}
